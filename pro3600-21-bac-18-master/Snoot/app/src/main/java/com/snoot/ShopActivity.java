    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mainActivity = new Intent(ShopActivity.this, MainActivity.class);
        ...
        podometreButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent podometreActivity = new Intent(ShopActivity.this, PodometreActivity.class);
        ...
        alarmButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent alarmActivity = new Intent(ShopActivity.this, AlarmActivity.class);
